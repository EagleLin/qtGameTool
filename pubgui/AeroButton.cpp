...
void AeroButton::paintEvent(QPaintEvent * pe)
{
    ...
    if(this->isEnabled())
    {
        ...
        button_shadowcolor=m_shadow;
    }
    else
    {
        button_color = QColor(128, 128, 128);
        button_shadowcolor=QColor(128, 128, 128);
    }
    ...
    gradient.setColorAt(0.4, button_shadowcolor);
    gradient.setColorAt(0.6, button_shadowcolor);
